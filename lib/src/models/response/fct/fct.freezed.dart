...
FctItem _$FctItemFromJson(Map<String, dynamic> json) {
  return _FctItem.fromJson(json);
}
...
mixin _$FctItem {
  ...
  @JsonKey(ignore: true)
  $FctItemCopyWith<FctItem> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FctItemCopyWith<$Res> {
  factory $FctItemCopyWith(FctItem value, $Res Function(FctItem) then) =
      _$FctItemCopyWithImpl<$Res, FctItem>;
  @useResult
...
/// @nodoc
class _$FctItemCopyWithImpl<$Res, $Val extends FctItem>
    implements $FctItemCopyWith<$Res> {
  _$FctItemCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_FctItemCopyWith<$Res> implements $FctItemCopyWith<$Res> {
  factory _$$_FctItemCopyWith(
          _$_FctItem value, $Res Function(_$_FctItem) then) =
      __$$_FctItemCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({Response response});
...
/// @nodoc
class __$$_FctItemCopyWithImpl<$Res>
    extends _$FctItemCopyWithImpl<$Res, _$_FctItem>
    implements _$$_FctItemCopyWith<$Res> {
  __$$_FctItemCopyWithImpl(_$_FctItem _value, $Res Function(_$_FctItem) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_FctItem implements _FctItem {
  const _$_FctItem({required this.response});

  factory _$_FctItem.fromJson(Map<String, dynamic> json) =>
      _$$_FctItemFromJson(json);
  ...
  @override
  String toString() {
    return 'FctItem(response: $response)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_FctItemCopyWith<_$_FctItem> get copyWith =>
      __$$_FctItemCopyWithImpl<_$_FctItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_FctItemToJson(
      this,
    );
  }
}

abstract class _FctItem implements FctItem {
  const factory _FctItem({required final Response response}) = _$_FctItem;

  factory _FctItem.fromJson(Map<String, dynamic> json) = _$_FctItem.fromJson;
