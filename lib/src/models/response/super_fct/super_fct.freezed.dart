...
SuperFctItem _$SuperFctItemFromJson(Map<String, dynamic> json) {
  return _SuperFctItem.fromJson(json);
}

/// @nodoc
mixin _$SuperFctItem {
  Response get response => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $SuperFctItemCopyWith<SuperFctItem> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SuperFctItemCopyWith<$Res> {
  factory $SuperFctItemCopyWith(
          SuperFctItem value, $Res Function(SuperFctItem) then) =
      _$SuperFctItemCopyWithImpl<$Res, SuperFctItem>;
  @useResult
...
/// @nodoc
class _$SuperFctItemCopyWithImpl<$Res, $Val extends SuperFctItem>
    implements $SuperFctItemCopyWith<$Res> {
  _$SuperFctItemCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_SuperFctItemCopyWith<$Res>
    implements $SuperFctItemCopyWith<$Res> {
  factory _$$_SuperFctItemCopyWith(
          _$_SuperFctItem value, $Res Function(_$_SuperFctItem) then) =
      __$$_SuperFctItemCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({Response response});
...
/// @nodoc
class __$$_SuperFctItemCopyWithImpl<$Res>
    extends _$SuperFctItemCopyWithImpl<$Res, _$_SuperFctItem>
    implements _$$_SuperFctItemCopyWith<$Res> {
  __$$_SuperFctItemCopyWithImpl(
      _$_SuperFctItem _value, $Res Function(_$_SuperFctItem) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_SuperFctItem implements _SuperFctItem {
  const _$_SuperFctItem({required this.response});

  factory _$_SuperFctItem.fromJson(Map<String, dynamic> json) =>
      _$$_SuperFctItemFromJson(json);
  ...
  @override
  String toString() {
    return 'SuperFctItem(response: $response)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SuperFctItemCopyWith<_$_SuperFctItem> get copyWith =>
      __$$_SuperFctItemCopyWithImpl<_$_SuperFctItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SuperFctItemToJson(
      this,
    );
  }
}

abstract class _SuperFctItem implements SuperFctItem {
  const factory _SuperFctItem({required final Response response}) =
      _$_SuperFctItem;

  factory _SuperFctItem.fromJson(Map<String, dynamic> json) =
      _$_SuperFctItem.fromJson;
