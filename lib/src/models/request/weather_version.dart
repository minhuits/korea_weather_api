...
class WeatherVersion {
  ...
  WeatherVersion({
    ...
    baseDateTime = dateTimeBase(date);
  }

  String dateTimeBase(DateTime dateTime) =>
  ...
  factory WeatherVersion.fromJson(MapJson json) {
    return _$WeatherVersionFromJson(json);
  }

  MapJson toJson() => _$WeatherVersionToJson(this);
}
